...
from sql.queries import q3_query1_materialized, q3_query1_non_materialized, q3_query2_materialized, q3_query2_non_materialized
import time
...
if __name__=="__main__":    
    ...
    result = exec_get_all(q3_query1_materialized, None)
    counter = 1
    print('++++++++++++++++++++++++++++++++++++++++++++++')
    ...
    q_start_time = time.time()
    result = exec_get_all(q3_query1_non_materialized, None)
    counter = 1
    print('++++++++++++++++++++++++++++++++++++++++++++++')
    for record in result:
        print(record)
    ...
    print("Running Materialized Version")
    q_start_time = time.time()
    result = exec_get_all(q3_query2_materialized, None)
    counter = 1
    print('++++++++++++++++++++++++++++++++++++++++++++++')
    for record in result:
        print(record)
    ...
    print("Running Non-Materialized Version")
    q_start_time = time.time()
    result = exec_get_all(q3_query2_non_materialized, None)
    counter = 1
    print('++++++++++++++++++++++++++++++++++++++++++++++')
    for record in result:
        print(record)
